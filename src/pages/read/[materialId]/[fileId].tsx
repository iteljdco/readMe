...
export default function ReadFile() {
  ...
  const { materialId, fileId } = router.query;
  ...
  return (
    <main style={s.page}>
      <button style={s.backBtn} onClick={() => router.push(`/materials/${materialId}`)}>
        ← Back to material
      </button>
...
const s: Record<string, React.CSSProperties> = {
  ...
  progressFill: {
    height: '100%',
    background: 'linear-gradient(90deg, #0099FF, #0077BE)',
